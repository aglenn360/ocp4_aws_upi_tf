...
module "bootstrap" {
  ...
  ignition                 = data.local_file.bootstrap-ignition.content
...
module "masters" {
  ...
  user_data_ign            = data.local_file.master-ignition.content
}
...
#  worker_sg_ids            = [module.vpc.master_sg_id]
#  root_volume_iops         = var.aws_master_root_volume_iops
#  root_volume_size         = var.aws_master_root_volume_size
#  root_volume_type         = var.aws_master_root_volume_type
#  target_group_arns        = module.vpc.aws_lb_target_group_arns
...
#  #ec2_ami                  = var.aws_ami
#  #user_data_ign            = var.ignition_master
#  user_data_ign            = data.local_file.worker-ignition.content
#}
